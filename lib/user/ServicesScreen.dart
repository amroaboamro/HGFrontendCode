...
class _ServicesState extends State<Services> {
  ...
  Future<List<Service>> _fetchServices() async {
    final response = await http.get(Uri.parse(global.ip + '/allServices'));
            ...
            FutureBuilder<List<Service>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (filteredServices.isEmpty && !_searchClicked)
                    filteredServices = servicesList!;
                  return Column(
                    children: [
                      if (filteredServices.isNotEmpty &&
                          filteredServices.any(
                              (service) => service.serviceType == 'Emergency'))
                        ServiceCarousel(
                      ...
                      if (filteredServices.isNotEmpty &&
                          filteredServices
                              .any((service) => service.serviceType == 'Care'))
                        ServiceCarousel(
                          services: filteredServices
                              .where((service) => service.serviceType == 'Care')
                              .toList(),
                          name: 'Care',
                        ),
                    ],
